...
<div class="container">
    ...
    <table class="table">
        ...
        <?php
             require '../../config.php';
             $result1 = mysqli_query($conn,"SELECT COUNT(*) FROM Request WHERE Status = "Pending"");
             $result2 = mysqli_query($conn, "SELECT COUNT(*) FROM Request WHERE Status = "Ongoing"");
             $result3 = mysqli_query($conn, "SELECT COUNT(*) FROM Request WHERE Status = "Completed"");
             $result4 = mysqli_query($conn, "SELECT COUNT(*) FROM Request");
             echo "<td>" . $result1 . "</td>";
             echo "<td>" . $result2 . "</td>";
             echo "<td>" . $result3 . "</td>";
             echo "<td>" . $result4 . "</td>";
