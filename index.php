            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="html/signup.html">Sign Up</a>
                        <a class="nav-item nav-link" href="html/signin.html">Login</a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p class="lead mb-5 text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non
                            possimus ab labore provident mollitia. Id assumenda voluptate earum corporis facere
                            quibusdam quisquam iste ipsa cumque unde nisi, totam quas ipsam.</p>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <h1 class="display-4 text-white mt-5 mb-2">Welcome to <br> KFUPM Maintenance System</h1>
                        <p class="lead mb-5 text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non
        ...
        <div class="container" id="about-us">
            <div class="row">
                <div class="col-md-12 mb-5">
                    ...
                    <hr>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A deserunt neque tempore recusandae
